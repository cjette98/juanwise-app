...
export const ICONS = {
  ...
  help: ['M9 8.3c0-1.9 1.5-3.3 3.4-3.3s3.4 1.4 3.4 3c0 1.7-1.2 2.4-2.3 3.2-1 .7-1.5 1.3-1.5 2.6v.4', 'M12 17.8v.01'],
  minus: ['M6 12h12'],
  pencil: ['M14.5 4.5l5 5L9 20l-5.5 1.5L5 16z', 'M6.5 17l3.5 3.5'],
  share: ['M5 14.5v5.5h14v-5.5', 'M7.5 8L12 3.5l4.5 4.5M12 4v9'],
} as const;
